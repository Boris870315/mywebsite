...
// Constants
const VALID_CHARS = `01010101010010010101010101010101010101010101010101010101010`;
	...
	return (
		<div
			style={{
				...
				marginLeft: -15,
				marginRight: -15,
				textShadow: 'var(--rain_text_shadow1)',
				fontSize: 50,
			}}>
			{stream.map((char, index) => (
				<a
					style={{
						...
						color: index === stream.length - 1 ? 'var(--rain_buttom_text)' : undefined,
						textShadow:
							index === stream.length - 1
								? 'var(--rain_text_shadow)'
								: undefined,
					}}>
					{char}
				</a>
